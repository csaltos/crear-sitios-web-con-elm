...
var $author$project$Main$gris = A3($mdgriffith$elm_ui$Element$rgb255, 180, 180, 180);
...
var $author$project$Main$azul = A3($mdgriffith$elm_ui$Element$rgb255, 0, 0, 255);
...
var $author$project$Main$turquesa = A3($mdgriffith$elm_ui$Element$rgb255, 0, 150, 150);
var $author$project$Main$viewHeader = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$Font$color($author$project$Main$azul),
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$Font$color($author$project$Main$turquesa),
					$author$project$Main$fontHeader
				]),
			_List_fromArray(
				[
...
var $author$project$Main$main = A2(
	...
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$Background$color($author$project$Main$gris),
