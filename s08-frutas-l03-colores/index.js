...
var $author$project$Main$view = A2(
	...
	_List_fromArray(
		[
			...
			{bottom: 16, left: 40, right: 20, top: 20})
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					{calorias: 46.0, fruta: 'Ciruela'},
					{calorias: 160, fruta: 'Aguacate'},
					{calorias: 282, fruta: 'Dátiles'},
					{calorias: 66, fruta: 'Lichi'}
				]))
		]));
...
var $author$project$Main$viewTitulo = A2(
	...
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$text('Frutas con calorías')
		]));
var $author$project$Main$main = A2(
	...
	A2(
		...
		_List_fromArray(
			[
				$author$project$Main$viewTitulo,
				A2(
